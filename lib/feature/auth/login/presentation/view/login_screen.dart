...
class LoginScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {  TextEditingController passwordController = TextEditingController();
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    const Text(
                      "سعداء بعودتك إلى منصة تقديم الشكاوى",
                      style: TextStyle(
                        fontFamily: "Cairo",
                        color: Colors.black,
                        fontSize: 18,
                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: TextButton(
                                ...
                                child: const Text("هل نسيت كلمة المرور؟",style: TextStyle(
                                    fontFamily: "Cairo",
                                    color: Colors.black),),
                              ),
                            ),
