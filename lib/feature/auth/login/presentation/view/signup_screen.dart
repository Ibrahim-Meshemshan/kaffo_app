...
class SignupScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {  TextEditingController passwordController = TextEditingController();TextEditingController confirmPasswordController = TextEditingController();
                ...
                child: Column(
                  ...
                  children: [
                    const Text(
                      ...
                      style: TextStyle(
                        color: Colors.black,
                        fontSize: 32,fontFamily: "Cairo",
                        fontWeight: FontWeight.bold,
                      ),
                    ),
                    const SizedBox(height: 8),
                    const Text(
                      "ابدأ رحلتك مع منصة تقديم الشكاوي",
                      style: TextStyle(
                        color: Colors.black,
                        ...
                        child: Column(
                          children: [
                            ...
                            TextFormField(
                              ...
                              decoration: const InputDecoration(
                                prefixIcon: Icon(Icons.person_outlined),
                                hintText: "الاسم الثاني",hintStyle: TextStyle(fontFamily: "Cairo",),
                                border: OutlineInputBorder(
                                  borderRadius: BorderRadius.all(Radius.circular(12)),
                                ),
                              ),
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: ()async {
                                  ...
                                  try {
                                    ...
                                    await writeSecureData("access_token", tokens['access_token']);
                                    ...
                                    print("🎉 User created!");
                                    // await loginCubit.login(LoginRequest(email: emailController.text,password: passwordController.text)
                                    //
                                    // );
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                const Text(" لديك حساب مسبقا؟ ",style: TextStyle(fontFamily: "Cairo",),),
                                GestureDetector(
                                  onTap: () {
                                    Navigator.push(context, MaterialPageRoute(builder: (context) {
                                      return LoginScreen();
